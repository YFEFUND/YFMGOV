...
contract YearnRewards {
  ...
  IERC20 constant public YFM = IERC20(0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e);
  ...
  function claimable(address _claimer) public view returns (uint) {
      uint _amount = YFM.balanceOf(_claimer);
      uint _adai = adai.balanceOf(address(this));
      uint _totalSupply = YFM.totalSupply();
      uint _balance = YFM.balanceOf(address(this));
  ...
  function claim(uint _amount) public {
      ...
      YFM.safeTransferFrom(msg.sender, address(this), _amount);
